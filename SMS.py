import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] NIROB CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS NIROB CYBER KING NIROB\033[1;30m")
os.system("git pull")
import os,requests,time
time.sleep(1)
os.system("clear")
os.system("xdg-open https://t.me/mrasel674")
logo3=("""
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  NIROB KHAN                              \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  mrasel674                                    \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟NIROB✮⃝  𝐈𝐍𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
